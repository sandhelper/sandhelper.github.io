const FULL_REVIEWS = [
    {
        "name": "Jill Davidson",
        "date": "Jul 3, 2020",
        "profile_picture": "Jill Davidson.png",
        "social_media_site": "Google",
        "link": "https://goo.gl/maps/kDFZ8fNkhv6qZQLR7",
        "content": "I rented last minute for my mother. It was easy to rent online via the website and delivery and pick up was a breeze. They dropped it off at our hotel and provided me with the lock box combo for the key.  The chair was absolutely essential for my mother's beach visit, she has MS and is 99% wheelchair bound.  We absolutely loved that it was electric and she could use it without assistance from others, where other rentals are push only. It was worth every penny! My mothers only negative was the chairs seat back was not the best angle for her back, so she just transferred to a camping style chair once on the beach."
    },
    {
        "name": "Carol Chunkala",
        "date": "Jun 26, 2020",
        "profile_picture": "Carol Chunkala.jpg",
        "social_media_site": "Facebook",
        "link": "https://www.facebook.com/carol.chunkala.16/posts/585241862398388",
        "content": "The company was wonderful to work with the sand helper was there before 9 am. It was so helpful to get around on the sand we had a wonderful vacation thank you Sand Helper for making it a stress free vacation. I would recommend this company to anyone."
    },
    {
        "name": "Nancy Bucceri",
        "date": "Jun 25, 2020",
        "profile_picture": "Nancy Bucceri.png",
        "social_media_site": "Google",
        "link": "https://goo.gl/maps/iXFij3PpZtvtdp3b9",
        "content": "Nick was responsive, friendly and very accommodating to our needs.  The scooter worked great on the sand and even on the pavement we had to cross to get to the beach.  In fact, it was a game changer for us since we can now get on the beach with relative ease. My husband could even go \"for a walk with me\" in the sand."
    },
    {
        "name": "Kelly Carnevale",
        "date": "Jun 24, 2020",
        "profile_picture": "Kelly Carnevale.png",
        "social_media_site": "Google",
        "link": "https://goo.gl/maps/jX7euAcc7cLg9m8k7",
        "content": "This company is amazing.  The chair I rented was great.  It looked brand new and was a smooth ride.  They delivered and picked up at my condo rental front door!  Amazing, kind, and professional service!!  Will be using them again in September when I return to OCMD."
    },
    {
        "name": "Molly Kuntz Vincze",
        "date": "Jun 16, 2020",
        "profile_picture": "Molly Kuntz Vincze.jpg",
        "social_media_site": "Facebook",
        "link": "https://www.facebook.com/molly.kuntzvincze/posts/10158450054318119",
        "content": "We genuinely appreciate Sand Helpers! They dropped off and picked up the sand helper for my sister who is battling brain cancer. Pricing is also very fair. This enabled her to enjoy the beach. We highly recommended them and will be using them again later this summer. Thank you so much!"
    },
    {
        "name": "Kimberlie Schrider",
        "date": "Jun 5, 2020",
        "profile_picture": "Kimberlie Schrider.png",
        "social_media_site": "Google",
        "link": "https://goo.gl/maps/yKEWUgzP15gt3KkLA",
        "content": "I literally NEVER write reviews, but I HAD to write one about this company and their services, because it was just that good!!! I was vacationing in Ocean City with my family. My mother is disabled and really wanted to join the rest of the family on the boardwalk. I Called Sand Helper to see about renting a scooter for my mom to use, and it was an AMAZING experience. Super friendly and professional. Extremely considerate and accommodating. Great prices, as well! Nick was the best! I will definitely be using their services every time I come to ocean city with my mom! If only all businesses could be this great!!! Im a very satisfied customer! 10 out of 10, I recomend😊 Thanks Again Nick!!!!"
    },
    {
        "name": "Chris Gigon",
        "date": "Oct 22, 2019",
...
const generateReviewsPageReviewRow = (review) => {
    ...
    const reviewerPhotoImgLinkEl = document.createElement("a");
    reviewerPhotoImgLinkEl.href = review.link;
    reviewerPhotoImgLinkEl.target = "#";
    ...
    reviewerPhotoImgLinkEl.appendChild(reviewerPhotoImgEl);
    reviewerPhotoEl.appendChild(reviewerPhotoImgLinkEl);
    ...
    const reviewerNameLinkEl = document.createElement("a");
    reviewerNameLinkEl.href = review.link;
    reviewerNameLinkEl.target = "#";
    const reviewerNameSpanEl = document.createElement("span");
    reviewerNameSpanEl.innerText = review.name;
    reviewerNameLinkEl.appendChild(reviewerNameSpanEl);
    reviewerNameEl.appendChild(reviewerNameLinkEl);
