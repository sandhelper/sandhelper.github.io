const REVIEWS = [{
    ...
    },
    {
        "name": "Daniella Slon",
        "date": "Aug 19, 2019",
        "profile_picture": "Daniella Slon.jpg",
        "social_media_site": "Facebook",
        "content": "Last year i went to Ocean City, MD and ended up in tears on the beach because I struggled to walk in the sand due to my disability. I grieved the loss of my beach days. Then this year I returned to Ocean City and found out about Sand Helper. What a joy to find out that my beach days were NOT over - thank you Sand Helper for enabling me to enjoy the beach without struggle and anxiety again!"
    },
    {
        "name": "otto bar",
        "date": "Aug 5, 2019",
...
const generateReviewRow = (review) => {
    ...
    logoImgEl.src = `./lib/images/reviews/${review.social_media_site}.png`;
    romwSourceLogoEl.appendChild(logoImgEl);
    ...
    reviewerPhotoImgEl.src = `./lib/images/reviews/${review.profile_picture}`;
