const isDevEnv = window.location.href.includes('github.io/sandhelper/locations') || window.location.href.includes('file://');
...
const rentalAgents = [
   ...
   {
      agent: "Grand Rental Station (COMING SOON)",
      phone: "302-227-7368",
   ...
   {
      agent: "Mac Bros. Beach Setups (COMING SOON)",
      phone: "252-435-4586",
      notes: "",
