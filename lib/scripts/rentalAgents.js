...
const theBeaches = {
   ...
   clearwaterPetersburgHub: {
      beach: "Clearwater/Petersburg Hub", // undefined beach name hides this location from the accordion
   ...
   clearwater: {
      beach: "Clearwater",
      location: { lat: 0, lng: 0 }, // 0,0 coordinates hides this location from the map
      state: "Florida",
   ...
   portCanaveral: {
      ...
      location: { lat: 28.4109, lng: -80.609 },
      state: "Florida",
      showInAccordion: true,
   },
   cocoaBeach: {
      beach: "Cocoa Beach",
      location: { lat: 28.3278, lng: -80.6119 },
      state: "Florida",
      showInAccordion: true,
   },
   satelliteBeach: {
      beach: "Satellite Beach",
      location: { lat: 28.1782, lng: -80.5932 },
      state: "Florida",
      showInAccordion: true,
   },
   indianHarbourBeach: {
      beach: "Indian Harbour Beach",
      location: { lat: 28.1494, lng: -80.5928 },
      state: "Florida",
      showInAccordion: true,
   },
   melbourneBeach: {
      beach: "Melbourne Beach",
      location: { lat: 28.0665, lng: -80.5586 },
      state: "Florida",
      showInAccordion: true,
   },
   /* Maryland Locations */
