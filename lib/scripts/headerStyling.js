...
const fbImage = "./lib/images/facebook.png";
const longMascot = "./lib/images/longMascot.png";
const shortMascot = "./lib/images/shortMascot.png";
const headerBackgroundImageURL = "./lib/images/headerBackground.jpg";
const longMascotIcon = "./lib/images/longMascotIcon.png";
